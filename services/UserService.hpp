...
public:
  ...
  std::vector<nlohmann::json> getUsers(const httplib::Request &req) {
  ...
  // PUBLIC PROFILE
  nlohmann::json getOnePublic(const bsoncxx::oid &user_oid) {
    using namespace bsoncxx::builder::basic;
    using json = nlohmann::json;
  ...
  nlohmann::json getOnePrivate(const bsoncxx::oid &user_oid) {
    using namespace bsoncxx::builder::basic;
    using json = nlohmann::json;
  ...
  bool updateProfile(const std::string &id, const nlohmann::json &body) {
    using namespace bsoncxx::builder::basic;
    using json = nlohmann::json;
