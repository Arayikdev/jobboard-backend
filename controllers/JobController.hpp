...
public:
  ...
  void createJob(const httplib::Request &req, httplib::Response &res,
  ...
  void updateJob(const httplib::Request &req, httplib::Response &res,
  ...
  void deleteJob(const std::string &companyId, const httplib::Request &req,
                 httplib::Response &res)
  {
    try
    {
      ...
      res.status = result.value("status", 200);
      res.set_content(result.dump(), "application/json");
    }
    catch (...)
    {
  ...
  void admindeletejob(const httplib::Request &req, httplib::Response &res)
  {
    try
    {
      std::string jobIdStr = req.matches[1].str();
      ...
      auto result = service.admindeleteJob(jobId);
